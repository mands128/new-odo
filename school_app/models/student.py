...
class Student(models.Model):
    ...
    course_list = fields.Many2one('school_course', 'student_id')
    # course_name = fields.Many2one('course_name')
    # course_desc = fields.Text(related='course_name.desc')
    # course_fee = fields.Integer(related='course_name.fee')
